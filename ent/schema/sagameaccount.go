...
// SAGameAccount holds the schema definition for the SAGameAccount entity.
type SAGameAccount struct {
	ent.Schema
}

// Fields of the SAGameAccount.
func (SAGameAccount) Fields() []ent.Field {
	return []ent.Field{
...
// Edges of the SAGameAccount.
func (SAGameAccount) Edges() []ent.Edge {
	return []ent.Edge{
		edge.From("owner", GameAccount.Type).Ref("sagame").Unique(),
	}
}
