...
func columnChecker(table string) func(string) error {
	checks := map[string]func(string) bool{
		...
		lineaccount.Table:             lineaccount.ValidColumn,
		masterwallettransaction.Table: masterwallettransaction.ValidColumn,
		pgslotaccount.Table:           pgslotaccount.ValidColumn,
		prettygameaccount.Table:       prettygameaccount.ValidColumn,
		sagameaccount.Table:           sagameaccount.ValidColumn,
		transfertransaction.Table:     transfertransaction.ValidColumn,
