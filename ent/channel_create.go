...
func (cc *ChannelCreate) SetUUID(u uuid.UUID) *ChannelCreate {
...
func (cc *ChannelCreate) AddUserIDs(ids ...int) *ChannelCreate {
	cc.mutation.AddUserIDs(ids...)
	return cc
}

// AddUser adds the "user" edges to the User entity.
func (cc *ChannelCreate) AddUser(u ...*User) *ChannelCreate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
